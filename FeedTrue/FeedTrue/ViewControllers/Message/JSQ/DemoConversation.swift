...
let AvatarLeonard =  JSQMessagesAvatarImageFactory.avatarImage(withUserInitials: "DL", backgroundColor: UIColor.jsq_messageBubbleGreen(), textColor: .white, font: UIFont.systemFont(ofSize: 15), diameter: 1)!

let AvatarCook = JSQMessagesAvatarImageFactory.avatarImage(withUserInitials: "TC", backgroundColor: UIColor.gray, textColor: UIColor.white, font: UIFont.systemFont(ofSize: 15), diameter: 1)!
...
func makeGroupConversation()->[JSQMessage] {
    conversation = [message, message2,message3, message4, message5, photoMessage, audioMessage] as! [JSQMessage]
    return conversation
}

func makeNormalConversation() -> [JSQMessage] {
    conversation = [message6, message7, message8, message9, photoMessage, audioMessage] as! [JSQMessage]
    return conversation
}
